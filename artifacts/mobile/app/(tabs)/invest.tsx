...
const styles = StyleSheet.create({
  ...
  mappingTitle: { fontSize: 15, fontWeight: "700", marginBottom: 14 },
  mappingRow: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14 },
  mappingEmoji: { fontSize: 22, width: 32, textAlign: "center", lineHeight: 26 },
  mappingInfo: { flex: 1 },
  mappingGoal: { fontSize: 14, fontWeight: "700" },
  mappingAccount: { fontSize: 12, marginTop: 3 },
  mappingPill: {
    paddingHorizontal: 10,
    paddingVertical: 5,
    borderRadius: 12,
  ...
  mappingPct: { fontSize: 12, fontWeight: "700" },
